...
-- =============================================================================
-- 31. MEDIA HUB
--     (Ver supabase/migrations/20260707_create_media_hub.sql)
--
--     Serviço oficial de arquivos do ERP — nenhum domínio é dono das mídias,
--     todos referenciam via media_usages (vínculo polimórfico, mesmo padrão
--     já usado em audit_logs.resource/resource_id). Puramente aditivo, zero
--     consumidor de código ainda. Bucket, RLS, migração de photo_url/proof_url
--     legados e qualquer API/UI ficam para entregas futuras.
-- =============================================================================
...
-- =============================================================================
-- 31.1 MEDIA HUB — RPC de troca atômica de primary
--      (Ver supabase/migrations/20260708_rpc_set_primary_media.sql)
--
--      DELETE + INSERT numa única transação — nenhuma leitura concorrente
--      observa a entidade sem primary nenhuma. Posse da entidade continua
--      validada na service layer via entityBelongsToCompany(), não aqui.
-- =============================================================================
